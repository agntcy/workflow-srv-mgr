...
The `workflow-srv-mgr` maintainers take all security issues in the project
seriously. Thank you for improving the security of `workflow-srv-mgr`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`workflow-srv-mgr` leverages GitHub's private vulnerability reporting.
