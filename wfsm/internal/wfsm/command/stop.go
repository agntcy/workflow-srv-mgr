...
Optional flags:
	...
	--agentDeploymentName the name of agent deployment to stop. Agent deployment name is the name of the agent in the manifest file.
		
Examples:
- Build an agent with a manifest and environment file:
	wfsm stop agentDeploymentName
`
...
func init() {
	//stopCmd.Flags().StringP(manifestPathFlag, "m", "", "Manifest file for the application")
